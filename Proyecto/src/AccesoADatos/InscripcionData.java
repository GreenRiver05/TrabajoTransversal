...
public class InscripcionData {
    ...
    public void guardarInscripcion(Inscripcion inscripcion) { //FUNCA
    ...
    public ArrayList<Inscripcion> obtenerInscripciones() { //FUNCA
    ...
    public ArrayList<Inscripcion> obtenerInscripcionesPorAlumno(int id) { //FUNCA
        Inscripcion inscripcion = null;
        Alumno alumno = null;
        Materia materia = null;
    ...
    public ArrayList<Inscripcion> obtenerMateriasCursadas(int id) { //FUNCA
        Inscripcion inscripcion = null;
        Alumno alumno = null;
        Materia materia = null;
        ArrayList<Inscripcion> materiasInscriptas = new ArrayList();
        String sql = "SELECT alumnos.Nombre,alumnos.apellido, materias.Nombre,  materias.Año, nota, materias.idMaterias\n"
                + "FROM alumnos, materias, inscripciones\n"
                + "WHERE alumnos.IdAlumno = inscripciones.idAlumnos\n"
                + "AND materias.idMaterias = inscripciones.idMaterias\n"
    ...
    public ArrayList<Inscripcion> obtenerMateriasNoCursadas(int id) {//FUNCA
        Inscripcion inscripcion = null;
        Alumno alumno = null;
        Materia materia = null;
    ...
    public void borrarInscripcionMateriaAlumno(int id) {//FUNCA
