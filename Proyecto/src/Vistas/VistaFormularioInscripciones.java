...
//      
//            } else {
//                for (Inscripcion i : inscData.obtenerMateriasNoCursadas(elegido.getId_Alumno())) {
//                    modeloTabla.addRow(new Object[]{i.getMateria().getId_Materia(), i.getMateria().getNombre(), i.getMateria().getAnio()});
//                }
//            }
//        }
...
//    data.eliminarinscripcion(inscripcion);
//    llenarTabla();
...
//            String nombre = (String) jTable1.getValueAt(filaElegida, 1);
//            int año = (int) jTable1.getValueAt(filaElegida, 2);
//            inscripcion.setId_Inscripcion(idInscripcion);
//            data.Inscribir(inscrpcion);
//            
//        }
